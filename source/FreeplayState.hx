...
class FreeplayState extends MusicBeatState
{
	...
	var daImage:String = 'backgrounds';
	...
	override function create()
	{
		...
		background = new FlxSprite().loadGraphic(Paths.image(daImage + '/' + MainMenuState.daBGShit[0]));
		...
		diffText.setBorderStyle(OUTLINE, FlxColor.BLACK, 2, 1);
		...
		var textBG:FlxSprite = new FlxSprite(0, FlxG.height - 32);
		textBG.makeGraphic(FlxG.width, 32, 0xFF000000);
		textBG.scrollFactor.set();
		textBG.alpha = 0.6;
		add(textBG);
		textBG.antialiasing = ClientPrefs.globalAntialiasing;
		#if PRELOAD_ALL
