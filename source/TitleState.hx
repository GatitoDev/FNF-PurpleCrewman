...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		var daFolder:String = 'logo' + '/' + 'anim';
		var daLogo:Array<String> = ['logoBumpin', 'logoCrew'];
		var daAnimLogo:Array<String> = ['logo bumpin', 'logo crew'];
		logoBeat = new FlxSprite(titleJSON.titlex, titleJSON.titley);
		logoBeat.frames = Paths.getSparrowAtlas(daFolder + '/' + daLogo[1]);
		logoBeat.animation.addByPrefix('beat', daAnimLogo[1], 24, false);
		logoBeat.animation.play('beat');
		...
		add(logoBeat);
		logoBeat.shader = swagShader.shader;
		...
		// FlxTween.tween(logoBeat, {y: logoBeat.y + 50}, 0.6, {ease: FlxEase.quadInOut, type: PINGPONG});
